...
The source code for this tutorial is live at [book/recognize_digits](https://github.com/PaddlePaddle/book/tree/develop/02.recognize_digits). To get started with Paddle, please refer to [installation instructions](https://github.com/PaddlePaddle/Paddle/blob/develop/doc/getstarted/build_and_install/docker_install_en.rst).

## Introduction
Handwriting recognition is a classic image classification problem. In particular, recognizing hand-written digits on [MNIST](http://yann.lecun.com/exdb/mnist/) is the deep learning equivalence to a 'Hello World!' program.

### MNIST

MNIST is a complete dataset containing images of handwritten digits and their corresponding labels. Each of the input image is a $28\times28$ matrix, and the label is one of the digits from $0$ to $9$ (Fig. 1). All images are normalized, meaning that they are both scaled and centered.
